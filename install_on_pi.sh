...
# Install USB rescan helper + service. Forces a USB bus re-enumeration at boot
# so the Berrybase / Jieli UAC speaker is detected after a cold power-cycle
# (otherwise it stays invisible until physically replugged).
